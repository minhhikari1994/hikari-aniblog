<template>
    <section id="sidebar">
        ...
        <section id="intro">
            <a href="#" class="logo"><img src="/images/logo.jpg" alt="" loading="lazy"/></a>
            <header>
        ...
        <AnimeWatchSchedule></AnimeWatchSchedule>

    </section>
</template>

<script setup>
import AnimeWatchSchedule from './AnimeWatchSchedule.vue';
</script>
